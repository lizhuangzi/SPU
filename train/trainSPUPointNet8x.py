...
sys.path.append('../')
import torch
from arch.SPUfinal8x import Generator
...
def train(args):
    ...
    for e in range(120):
        ...
        if Bestacc < top1.avg:
            Bestacc = top1.avg
            torch.save(G_model.state_dict(), './savedModel/SPU_Final8XModel.parm')
        ...
        data_frame.to_csv(out_path + 'SPU_Final8XModel' + '.csv', index_label='Epoch')
