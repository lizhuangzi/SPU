...
class ModelNet40spu(Dataset):
    ...
    """
    def __init__(self, num_points=1024, data_dir="./", partition='train',use_norm=True,upscalefactor=4,n_repeat=20):
    ...
    def __getitem__(self, item):
        # if self.partition == 'train':
        #     pointcloud = self.data[item%16][:self.num_points]
        #     label = self.label[item%16]
        # else:
    ...
    def __len__(self):
        return self.data.shape[0]*self.repeat
