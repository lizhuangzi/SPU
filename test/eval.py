...
parser.add_argument('--resume',default='/home/lizhuangzi/Desktop/PUGAN-pytorch/checkpoints/Test1/G_iter_19.pth', type=str, required=False)
...
if __name__ == '__main__':
    ...
    eval_dst = PUNET_Dataset(h5_file_path='../data/Patches_noHole_and_collected.h5', split_dir=param['test_split'], isTrain=False)
